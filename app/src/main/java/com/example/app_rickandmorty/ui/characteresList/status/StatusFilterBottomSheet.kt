...
import com.example.app_rickandmorty.databinding.StatusFilterBottomSheetBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class StatusFilterBottomSheet : BottomSheetDialogFragment() {

    private lateinit var _binding: StatusFilterBottomSheetBinding
    ...
    override fun onCreateView(
        ...
        _binding = StatusFilterBottomSheetBinding.inflate(inflater, container, false)
        _binding.apply {
